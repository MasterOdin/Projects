Mega Project List
========
A method of practicing coding using a giant list of project ideas and implemented probably in Python.  
  
While this is a public repo, I probably will never accept a pull request for a solution. Feel free to commit about the validity of a solution or how I'd improve one in an issue.
...
[**Collatz Conjecture**](https://github.com/MasterOdin/Projects/blob/master/Classic%20Algorithms/collatz_conjecture.py) - Start with a number *n > 1*. Find the number of steps it takes to reach one using the following process: If *n* is even, divide it by 2. If *n* is odd, multiply it by 3 and add 1.
